...
acc: 15 / acc + cur.length = 15 + 3 / newTitle = ['Pasta', 'with', 'tomato'] over 16 so 'and' isn't pushed
...
export const limitRecipeTitle = (title, limit = 17) => {
    ...
    if (title.length > limit) {
        title.split(' ').reduce((acc, cur) => {
            ...
            return acc + cur.length; //upatae the accumulator for the next loop
        }, 0)
        //return the result
        ...
        <li>
            <a class="results__link" href="#${recipe.id}">
                ...
                <div class="results__data">
                    ...
                    <p class="results__author">Preparation Time: ${recipe.readyInMinutes} minutes</p>
                </div>
            </a>
        </li>
    `;
